...
(function( context ){
  ...
  'use strict';
    ...
    var JQUERY_TOKEN           = require( 'jquery-browserify' );
    var UNDERSCORE_TOKEN           = require( 'underscore' );
    var LouRawls = {};
  /**
   *
   ...
   *  @param Arguments.debug {Boolean} - Whether to log errors or not
   *
   */
  ...
  var Router = function( Arguments ){
    ...
    this.debug = Arguments.debug || false;
  
    // Build supported events
  
    UNDERSCORE_TOKEN.each( UNDERSCORE_TOKEN.keys( this.events ), function( val ){
  
      if( !UNDERSCORE_TOKEN.contains( this._events, val ) ){
  ...
  Router.prototype.start = function(){
    ...
    UNDERSCORE_TOKEN.each( this._events, function( val ){
  ...
  Router.prototype.publish = function( eventType ){
    ...
    if( UNDERSCORE_TOKEN.contains( this._events, eventType ) ){
  
      routes = this.getMatchingRoutes( eventType, pathname );
  
      if( routes.length >= 1 ){
      
        UNDERSCORE_TOKEN.each( routes, function( route ){
        ...
        if( this.debug ){
          console.log( 'Unhandled Route Exception: ' , this.routes, eventType, pathname );
        }
      ...
      if( this.debug ){
        console.log( 'Unhandled Event Exception: ' , eventType );
      }
  ...
  Router.prototype.subscribe = function(){
    ...
    UNDERSCORE_TOKEN.each( this._events, function( val ){
      ...
      switch( val ){
        ...
        case 'Load':
          JQUERY_TOKEN( window ).load( function(){
            this.publish( val );
          }.bind( this ));
          //console.log( 'load bound' );
          break;
        case 'DOMReady':
          JQUERY_TOKEN( 'document' ).ready( function(){
            this.publish( val );
          }.bind( this ));
          //console.log( 'document bound' );
          break;
        default:
          JQUERY_TOKEN( this ).on( val, function(){
            this.publish( val );
          }.bind( this ));
  ...
  Router.prototype.getMatchingRoutes = function( eventType, pathname ){
    ...
    UNDERSCORE_TOKEN.each( this.routes, function( val, key ){
  ...
  Router.prototype.extractParameters = function( route ) {
    ...
    return UNDERSCORE_TOKEN.map(params, function(param) {
  ...
  Router.prototype.advise = function( Arguments ){
    ...
    if( typeof aspectMap === 'undefined' ){
      ...
      (function adviseSynchronously( aspectMap ){
        ...
        UNDERSCORE_TOKEN.each( aspectMap.aspects, function( aspect ){
  
          // @TODO: Throw errors correctly for undefined aspects
  ...
  LouRawls.AspectDefinition = function( aspects ){
  ...
  LouRawls.Aspect = function( aspectFunction ){
  ...
  LouRawls.AspectMap = AspectMap;
  
  context['LouRawls'] = LouRawls;
}( this ));

},{"jquery-browserify":3,"underscore":4}],2:[function(require,module,exports){
/**
 *
...
},{"./LouRawls":1}],3:[function(require,module,exports){
